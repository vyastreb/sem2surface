...
imgNames = [os.path.join(current_dir, 'P33_scale2s3_detectorA.tif'),
            os.path.join(current_dir, 'P33_scale2s3_detectorB.tif'),
            os.path.join(current_dir, 'P33_scale2s3_detectorC.tif')]
