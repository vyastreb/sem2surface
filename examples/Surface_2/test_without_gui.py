...
imgNames = [os.path.join('P33_scale2s3_detectorA.tif'),
            os.path.join('P33_scale2s3_detectorB.tif'),
            os.path.join('P33_scale2s3_detectorC.tif')]
...
Z_current = 20.16   # For CrN (main elements Cr, Z=24, and N, Z=7, in proportions 1:1, in mass percentage, w_Cr=24/31, w_N=7/31
# so the effective Z_CrN = 24*24/31+7*7/31=20.16)
